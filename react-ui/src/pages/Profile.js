                ...
                <div className="md:grid md:grid-cols-3 md:gap-6">
                    <div className="md:col-span-1">
                        <div className="px-4 sm:px-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600">Используйте постоянный адрес, для доставки ваших заказов.</p>
                        </div>
                    </div>
                            ...
                            <div className="overflow-visible shadow-xl shadow-gray-500/50 sm:rounded-md ">
                                <div className="bg-white px-4 py-5 sm:p-6">
                                    <div className="grid grid-cols-6 grid-rows-5 gap-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-2 row-start-3 row-end-3">
                                            ...
                                            <input
                                                ...
                                                disabled readOnly
                                                value="Россия"
                                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm shadow-gray-600/50 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm text-gray-500 indent-2"
                                            />
                                        </div>
